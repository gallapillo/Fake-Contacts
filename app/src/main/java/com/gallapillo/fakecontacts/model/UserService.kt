...
/* Пользоватльский слушатель модели User */
typealias UsersListener = (users: List<User>) -> Unit

/* Сервисный класс пользователя для работы с моделью */
...
class UserService {
    ...
    /* Инициализация объекта UserService с помощью билеотеки faker */
    init {
    ...
    /* Удаление пользователя из списку */
    ...
    /* Перемещение пользователя по списку */
    ...
    /* Умедовление измений слушателей */
